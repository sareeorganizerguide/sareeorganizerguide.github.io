(function () {
    ...
    function setupQuickNav() {
        var qLinks = document.querySelectorAll('.quick-nav-list a');
        var navLinks = document.querySelectorAll('.nav-link');
        var sections = [];

        qLinks.forEach(function (link) {
        ...
        function updateActive() {
            ...
            qLinks.forEach(function (l) { l.classList.remove('active'); });
    ...
    function setupSmoothScroll() {
        document.addEventListener('click', function (e) {
            ...
            var qHeight = quickNav ? quickNav.offsetHeight : 0;
            var offset = headerHeight + qHeight + 16;
    ...
    function setupRatingBars() {
        var bars = document.querySelectorAll('.bar-fill, .mat-fill');
